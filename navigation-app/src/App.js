  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/room/외부인의 방" element={<ExternalRoom />} />
        <Route path="/room/외부인의 방/next" element={<ExternalRoomClues />} />
        <Route path="/room/보급실" element={<VaultRoom />} />
        <Route path="/room/보급실/next" element={<VaultRoomClues />} />
        <Route path="/room/실험실" element={<LabRoom />} />
        <Route path="/room/실험실/next" element={<LabRoomClues />} />
